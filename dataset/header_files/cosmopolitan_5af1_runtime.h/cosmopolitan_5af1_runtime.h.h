...
/*鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹傗攢鈺
鈹 cosmopolitan 搂 runtime                                                   鈹鈺鈹鈹傗敿
鈺氣攢鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹鈹*/
...
extern unsigned char _base[];               /* 伪p蔚 */
extern unsigned char _ehead[];              /* 伪p蔚 */
extern unsigned char _etext[];              /* 伪p蔚 */
extern unsigned char _edata[];              /* 伪p蔚 */
extern unsigned char _ezip[];               /* 伪p蔚 */
extern unsigned char _end[];                /* 伪p蔚 */
extern unsigned char _ereal[];              /* 伪p蔚 */
extern unsigned char __privileged_start[];  /* 伪p蔚 */
extern unsigned char __privileged_addr[];   /* 伪p蔚 */
extern unsigned char __privileged_size[];   /* 伪p蔚 */
extern unsigned char __privileged_end[];    /* 伪p蔚 */
extern unsigned char __test_start[];        /* 伪p蔚 */
extern unsigned char __ro[];                /* 伪p蔚 */
extern unsigned char *__relo_start[];       /* 伪p蔚 */
extern unsigned char *__relo_end[];         /* 伪p蔚 */
extern uint8_t __zip_start[];               /* 伪p蔚 */
extern uint8_t __zip_end[];                 /* 伪p蔚 */
extern uint8_t __data_start[];              /* 伪p蔚 */
extern uint8_t __data_end[];                /* 伪p蔚 */
extern uint8_t __bss_start[];               /* 伪p蔚 */
extern uint8_t __bss_end[];                 /* 伪p蔚 */
